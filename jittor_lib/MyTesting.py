...
parser.add_argument('--pth_path', type=str, default='./snapshot_jittor_big_30/SINet_V2/Net_epoch_best.pkl')
opt = parser.parse_args()


for _data_name in ['CAMO', 'COD10K', 'CHAMELEON', 'NC4K']:
    data_path = './Dataset/TestDataset/{}/'.format(_data_name)
    save_path = './res_jittor_pkl_big_30/{}/{}/'.format(opt.pth_path.split('/')[(- 2)], _data_name)
    model = Network()
